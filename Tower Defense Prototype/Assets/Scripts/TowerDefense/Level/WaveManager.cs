...
namespace TowerDefense.Level
{
    ...
    public class WaveManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Cuanto incrementamos el recurso $ de habilidad con cada nueva oleada
        /// </summary>
        public int incrementAbilityResource = 50;
        ...
        protected virtual void InitCurrentWave()
        {
            ...
            wave.Init();
            AbilityResourceManager.ablRscManager.AddAbilityResource(incrementAbilityResource);
            if (waveChanged != null)
            {
                waveChanged();
            }
