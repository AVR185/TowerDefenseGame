...
namespace TowerDefense.UI.HUD
{
	...
	public class TowerInfoDisplay : MonoBehaviour
	{
		...
		public void Show(Tower tower, int levelOfTower)
		{
			...
			DisplayText(towerName, 
                (Application.systemLanguage.Equals(SystemLanguage.Spanish) & !string.IsNullOrEmpty(tower.spanishTowerName))?
                tower.spanishTowerName : tower.towerName);
