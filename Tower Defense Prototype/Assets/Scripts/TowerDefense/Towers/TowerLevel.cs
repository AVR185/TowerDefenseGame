...
namespace TowerDefense.Towers
{
	...
	public class TowerLevel : MonoBehaviour, ISerializationCallbackReceiver
	{
		...
		public string description
		{
			get
            {
                if (Application.systemLanguage.Equals(SystemLanguage.Spanish) & 
                    !string.IsNullOrEmpty(levelData.spanishDescription))
                    return levelData.spanishDescription;
                else
		...
		public string upgradeDescription
		{
            ...
            {
                if (Application.systemLanguage.Equals(SystemLanguage.Spanish) &
                    !string.IsNullOrEmpty(levelData.spanishUpgradeDescription))
                    return levelData.spanishUpgradeDescription;
                else
                    return levelData.upgradeDescription;
            }
        }
